...
$link=Conectarse();
$consulta = mysql_query("select * from users where id > 20936 AND id < 25000  ORDER BY id ",$link);
while ($row = mysql_fetch_row($consulta)){
$actual =  $row[0];
$actualmenosuno = $actual - 1;
echo $actual." - ".$actualmenosuno."<br>";
mysql_query("update users SET id = '$actualmenosuno' where id = '$actual'",$link);
echo mysql_error();
}
?>
<?php
