...
$Usuario = "root";
$Password = "toor";
$BaseDeDatos ="oncomedi_Oncomedic";
/*
$Servidor = "localhost";
$Usuario = "oncomedi_administrativo";
$Password = "camPUS5829";
$BaseDeDatos ="oncomedi_Oncomedic";
*/
   if (!($link_oncolinux=mysql_connect($Servidor,$Usuario,$Password)))
   {
      echo "Error conectando a la base de datos.";
      exit();
   }
   if (!mysql_select_db($BaseDeDatos,$link_oncolinux))
   {
      echo "Error seleccionando la base de datos.";
      exit();
   }
   return $link_oncolinux;
